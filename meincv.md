...
**Robotics Research Lab** | Binh Duong, Vietnam
*Leading Engineer* | Jan 2026 – Present
* Building the foundation for autonomous robots.
* Architecting and optimizing proprietary robotic control systems and real-time infrastructure (specific system logic and operational metrics are under NDA).
* Leading the hardware-software integration layer, ensuring high-availability communication between embedded components and centralized control nodes.
...
* Architecting a standalone e-commerce platform integrated with specialized AI agents.
